...
<details>
    ...
    <div class="details-box">
        <!-- Why did I participate? -->
        デジタル創作同好会traPの先輩からおすすめされて参加しました。
...
<details>
    ...
    <div class="details-box">
        ...
        <!-- When, Where What and How did I do? -->
        <!-- What I learned -->
        「春の新入生相談会」「秋の大学生活なんでも相談会」「系所属相談会」などの対面・オンラインの相談会の他、「ピアちゃんのリプライ箱」という投書型相談活動、各キャンパスを1ヶ月毎にまわることでコミュニケーションを促す「ぐるっと！！ぴあノート」など、様々な活動を実施しています。<br>
        また、全国のピアサポート団体が集まる「ぴあのわ」というイベントに参加して、より良いピアサポートを研究・実践しています。
    </div>
</details>
<details>
    <summary>
...
<details>
    ...
    <div class="details-box">
        <!-- Why did I participate? -->
        講義内容（特にリバースエンジニアリング）に興味があり、応募しました。
        <!-- When, Where What and How did I do? -->
        <!-- What I learned -->
...
<details>
    ...
    <div class="details-box">
        <!-- Why did I participate? -->
        過去に参加・修了した現地開催のセキュリティキャンプから5年以上が経過していないと受講生としては参加できないので、今度はチューターとして参加しました。
        <!-- When, Where What and How did I do? -->
        <!-- What I learned -->
...
<details>
    ...
    <div class="details-box">
        <!-- Why did I participate? -->
        知り合い複数人からおすすめされ、夏休みの期間で集中的に低レイヤプログラミングの能力を高められると思い、応募しました。
        <!-- When, Where What and How did I do? -->
        基本的には、C言語でC言語の標準ライブラリ関数を実装していきました。
        他者に自分のコードを説明して納得してもらわないと次の課題に進めない、という面白いシステムで、しっかりと理解を深められる仕組みになっていたと思います。チーム課題もありました。
        <!-- What I learned -->
...
<details>
    ...
    <div class="details-box">
        <!-- Why did I participate? -->
        <!-- When, Where What and How did I do? -->
        東京科学大学に興味を持っている女子高校生に向けて、自分の学生生活や目標について話しました。
        <!-- What I learned -->
